...
exports.getAssessments = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const assessmentsResult = await (0, connection_1.query)(`SELECT a.id, a.class_id, a.assessment_type_id, a.name, a.description, 
...
exports.createAssessment = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const result = await (0, connection_1.query)(`INSERT INTO assessments (class_id, assessment_type_id, name, description, due_date, max_score)
     VALUES ($1, $2, $3, $4, $5, $6)
     RETURNING id, class_id, assessment_type_id, name, description, due_date, max_score, created_at`, [class_id, assessment_type_id || null, name, description || null, due_date || null, max_score]);
    const response = {
        success: true,
        data: result.rows[0],
...
exports.updateAssessment = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const result = await (0, connection_1.query)(`UPDATE assessments
     SET name = COALESCE($1, name), 
         ...
         updated_at = NOW()
     WHERE id = $5
     RETURNING id, class_id, assessment_type_id, name, description, due_date, max_score, is_published, updated_at`, [name || null, description || null, due_date || null, max_score || null, assessmentId]);
    const response = {
        success: true,
        data: result.rows[0],
...
exports.deleteAssessment = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    await (0, connection_1.query)('DELETE FROM assessments WHERE id = $1', [assessment_id]);
    const response = {
        success: true,
        data: null,
